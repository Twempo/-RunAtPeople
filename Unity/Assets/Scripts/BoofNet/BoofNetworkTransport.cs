...
namespace BoofNet {
    public class BoofNetworkTransport : INetworkTransport {
        ...
        public int AddHostWithSimulator(
        ...
        public void ConnectAsNetworkHost(
          int hostId,
          string address,
          int port,
          NetworkID network,
        ...
        public int ConnectToNetworkPeer(
          int hostId,
          string address,
          int port,
          int specialConnectionId,
        ...
        public void GetBroadcastConnectionInfo(
          int hostId,
          out string address,
          out int port,
          out byte error) {
        ...
        public void GetBroadcastConnectionMessage(
          int hostId,
          byte[] buffer,
          int bufferSize,
        ...
        public void SetBroadcastCredentials(
          int hostId,
          int key,
          int version,
          int subversion,
        ...
        public bool StartBroadcastDiscovery(
          int hostId,
          int broadcastPort,
          int key,
          int version,
